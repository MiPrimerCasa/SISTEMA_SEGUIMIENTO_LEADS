/** Grupo de opciones binarias tipo Sí/No o A/B — altura 52px, active bordó */
export function ButtonGroup({ label, options, value, onChange, name }) {
  return (
...
/** Radio card — fila completa con dot personalizado, min-h 56px */
export function RadioCard({ label, checked, onChange, name, value }) {
  return (
    <label
...
/**
 * Sección de formulario — sin contenedor con borde, solo eyebrow + contenido.
 * Prop opcional `step` para mostrar "TÍTULO · paso X de N".
 */
export function FormSection({ title, step, totalSteps, children, visible = true }) {
